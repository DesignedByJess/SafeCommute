...
export const env: EnvConfig = {
  ...
  FLUTTERWAVE_ENCRYPTION_KEY: getEnv('FLUTTERWAVE_ENCRYPTION_KEY', ''),
  FLUTTERWAVE_SECRET_HASH: getEnv('FLUTTERWAVE_SECRET_HASH', ''),
  WHATSAPP_API_TOKEN: getEnv('WHATSAPP_API_TOKEN', ''),
  WHATSAPP_PHONE_NUMBER_ID: getEnv('WHATSAPP_PHONE_NUMBER_ID', ''),
  AFRICA_TALKING_API_KEY: getEnv('AFRICA_TALKING_API_KEY', ''),
  AFRICA_TALKING_USERNAME: getEnv('AFRICA_TALKING_USERNAME', ''),
