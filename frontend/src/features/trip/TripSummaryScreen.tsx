  ...
  return (
    ...
    >
      <div className="px-6 pt-14 pb-4">
        ...
        <p className="text-sm text-gray-500 mt-0.5 text-center">Review your trip details before sharing</p>
      </div>
        ...
        <div className="bg-white rounded-2xl overflow-hidden">
          {rows.map((row) => {
            ...
            return (
              <div
                key={row.label}
                className="flex items-center gap-3 px-4 py-3.5 rounded-lg border-b border-gray-100"
              >
